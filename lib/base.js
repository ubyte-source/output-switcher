(function (window) {
	...
	class Result {
		...
		update() {
			...
			tbody.drop();
			tbody.addRow(
				window.Table.Tr.Td.content(window.moment.unix(saving_date.from).utc().format(window.Switcher.Info.format())),
				window.Table.Tr.Td.content(window.moment.unix(saving_date.to).utc().format(window.Switcher.Info.format())),
			...
			tbody.addRow(
				window.Table.Tr.Td.content(window.moment.unix(bypass_date.from).utc().format(window.Switcher.Info.format())),
				window.Table.Tr.Td.content(window.moment.unix(bypass_date.to).utc().format(window.Switcher.Info.format())),
	...
	class Total {
		...
		addRow(date, saving, bypass) {
			...
			tbody.addRow(
				...
				window.Table.Tr.Td.content(window.moment.unix(date).utc().format(window.Switcher.Info.format())),
